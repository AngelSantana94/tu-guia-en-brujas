    ...
    <div className="fixed inset-0 z-[10000] bg-base-100 flex flex-col w-full h-full overflow-y-auto">
      ...
      <div className="flex-1 w-full max-w-md mx-auto px-6 py-4 flex flex-col shadow-[0_25px_60px_-15px_rgba(168,85,247,0.3)]">
        ...
        <div className="space-y-4">
          ...
          {/* CONTENEDOR DEL PHONE INPUT DE LA LIBRERÍA */}
          <div
            className="pt-4 px-6 phone-step-container w-full 
            [&_.react-international-phone-country-selector-button]:!w-20 
            [&_.react-international-phone-country-selector-button]:!h-16 
          ...
          >
            <PhoneInput
              ...
              inputClassName="!flex-1 !h-16 !border-2 !border-base-300 !rounded-2xl !bg-base-100 !text-base-content !px-4 !text-base focus:!border-neutral !transition-colors !font-medium"
            />
          </div>
        </div>
